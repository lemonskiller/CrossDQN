...
if __name__ == '__main__':
    # demo_tfrecord_data(
    #     "/Users/zhiyu9/Downloads/CrossDQN-feed/data/action15-test-00031")
    demo_tfrecord_data(DATA_PATH)
    # train_input_fn = input_fn_maker(
    #     "/Users/zhiyu9/Downloads/CrossDQN-feed/data/action6-test-00001")
